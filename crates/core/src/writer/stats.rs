...
#[allow(dead_code)]
/// Creates an [`Add`] log action struct.
/// Note that this function uses the ParquetMetaData struct which is typically obtained when
/// reading Parquet files. In all other ways, this function is identical to `create_add`.
